            ...
            <table class="table table-light">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td>
                            ...
                            <form action="{{route('admin.technologies.update', $technology)}}" method="post">
                                ...
                                <div class="input-group">
                                    <input class="form-control border-0 bg-transparent" type="text" name="name" id="name" value="{{$technology->name}}" aria-describedby="editInput-{{$technology->id}}">

                                    <span class="input-group-text border-0">
                                        <i class="fa-solid fa-pencil" id="editInput-{{$technology->id}}"></i>
                                    </span>
                                </div>
                        ...
                        <td>
                            <span class="badge bg-dark">{{ $technology->technologies->count()}}</span>
